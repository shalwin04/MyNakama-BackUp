...
const InitializeAI = async () => {
  ...
  const questionPrompt = PromptTemplate.fromTemplate(
    ...
    // ----------------
    // QUESTION: {question}
    `You are a compassionate and insightful mental health therapist. Please respond to the user's question based on the context provided, keeping your response warm, accepting, and empathetic. Your goal is to provide a safe space, help the user become a better version of themselves, and offer practical solutions to their mental health concerns.
    ...
    Ask the user an Insightful Follow-up Question. Encourage the user to reflect on their experiences by asking open-ended questions that help them identify specific aspects of their concerns.
    Offer practical suggestions or techniques that could help manage their situation, such as time management tips, relaxation exercises, or coping
  ...
  const journalPrompt = PromptTemplate.fromTemplate(
    ...
    `If the following text contains references to suicidal thoughts or severe mental health concerns,
     generate a message addressed to the emergency contact, highlighting the user's need for special care in a third person's perspective.
